...
# get the name of the folder where this script is located
$appNameFromFolder = "SimplePackingList"

$folderNames = @()
$folderNames += "${appNameFromFolder}_${largestVersion}_x64_Test"
$folderNames += "${appNameFromFolder}_${largestVersion}_arm64_Test"
...
$bundleName = "${currentPath}\${trimmedMsixesFolder}\${appNameFromFolder}_${largestVersion}.msixbundle"
